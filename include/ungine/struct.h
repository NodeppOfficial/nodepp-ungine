...
namespace ungine { namespace shape { enum MODE {
    ...
    SHAPE_MODE_FACE      = 0x00000001,
    SHAPE_MODE_WIRE      = 0x00000010
...
namespace ungine { namespace rl { struct GBufferRenderTexture {
    uint id, width, height  , depth;
    Texture albedo, position;
}; }}
...
namespace ungine {
    using ray_hit_t   = rl::RayCollision;
    using box_t       = rl::BoundingBox;
...
namespace ungine { struct shape_2D_t {
    int mode /**/ = shape::MODE::SHAPE_MODE_FACE;
    color_t color = rl::WHITE; model_t model;
    rect_t sprite ; box_t bound;
};}

namespace ungine { struct shape_3D_t {
    int mode /**/ = shape::MODE::SHAPE_MODE_FACE;
    color_t color = rl::WHITE; model_t model;
    animation_frame_t animation; box_t bound;
};}
